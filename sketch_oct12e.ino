...
// const char* websocket_server_host = "192.168.148.177"; // Replace with your server's IP
...
#define RST_PIN         0   // D3 on WeMos D1 Mini
#define SS_PIN          2   // D4 on WeMos D1 Mini
#define BUZZER_PIN      15  // D8 on WeMos D1 Mini
...
void setup() {
    Serial.begin(115200);
    while (!Serial);
    SPI.begin(14, 12, 13, 2);  // SCK=D5, MISO=D6, MOSI=D7, SS=D4
    mfrc522.PCD_Init();
    pinMode(BUZZER_PIN, OUTPUT);
